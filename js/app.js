...
function updateLanguageDOM(lang) {
    ...
    // Update massage chair image src dynamically
    const massageChairImg = document.getElementById("massage-chair-image");
    if (massageChairImg) {
        massageChairImg.src = lang === "ta" 
            ? "assets/massage_chair_banner.jpg" 
            : "assets/massage_chair.png";
    }
